...
public:
	...
	void wall(); // для уворачивания от стен. dodge walls
...
private:
	mutable std::vector<FishType> types; // все типы рыб в аквариуме. mutable, потому что рыбы могут влиять друг на друга
